...
export default function MalaPage() {
  ...
  const [category, setCategory] = useState<string | null>("KIDS JEWELLERY");
          ...
          <div className="lg:col-span-3 space-y-8 bg-white">
            <div className="flex flex-col gap-2 m-6 ">
              <p className="text-xs text-gray-400">
                Home / <span className="text-gray-600 font-medium">{category || "KIDS_JEWELLERY"}</span>
              </p>

              <h1 className="text-2xl md:text-8xl p-10 font-montserrat text-[var(--text_skin)]">
                {category || "KIDS_JEWELLERY"}
              </h1>
            </div>
<p  className="xl:ml-17">Elegant and stylish kis Jewllery crafted with premium materials.</p>
