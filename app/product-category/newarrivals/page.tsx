...
export default function NewArrivalPage() {
  // CATEGORY + SEARCH
  const [category, setCategory] = useState<string | null>(null); // no default, shows all
        ...
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-3 space-y-8 bg-white">
            ...
            <div className="flex flex-col gap-2 m-6">
              <p className="text-xs text-gray-400">
                ...
                <span className="text-gray-600 font-medium">
                  {activeCategory || "NECKLACE | ACCESSORIES | BRACELETS | PENDANTS"}
                </span>
              </p>
            ...
            <p className="mt-4 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-[38px] text-gray-700 max-w-3xl">
              Elegant and stylish New Arrivals crafted with premium materials.
            </p>
                        </div>
                        {/* PRODUCTS */}
                        <div className="px-5">
