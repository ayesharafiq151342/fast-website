...
export default function MalaPage() {
  ...
  const [category, setCategory] = useState<string | null>("CHOKER");
          ...
          <div className="lg:col-span-3 space-y-8 bg-white">
            <div className="flex flex-col gap-2 m-6 ">
              <p className="text-xs text-gray-400">
                Home / <span className="text-gray-600 font-medium">{category || "CHOKER"}</span>
              </p>
...
<p  className="xl:ml-17">Elegant and stylish CHOKER crafted with premium materials.</p>
