...
export default function ChokerPage() {
  // CATEGORY + SEARCH
  const [category, setCategory] = useState<string | null>("MEHNDI JEWELLERY");
            ...
            <div className="flex flex-col gap-2 m-6">
              <p className="text-xs text-gray-400">
                ...
                <span className="text-gray-600 font-medium">
                  {activeCategory || "MEHNDI JEWELLERY"}
                </span>
              </p>
...
<p className="mt-4 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-[38px] text-gray-700 max-w-3xl">
  Elegant and stylish Mehndi jewellery crafted with premium materials.
</p>
            </div>
            {/* PRODUCTS */}
            <div className="px-5">
