...
<section className="min-h-screen flex items-center justify-center bg-gray-100">
  <div className="w-full mt-2 grid grid-cols-1 lg:grid-cols-2 gap-6 items-center px-6 lg:px-16">
    ...
    {/* RIGHT IMAGE ON MOBILE, LEFT ON DESKTOP */}
    <motion.div
    ...
    >
      <img
        ...
        alt="Business Man"
        className="rounded-2xl w-full h-80 sm:h-[500px] lg:h-[800px] object-cover"
      />

      {/* STATS CARD */}
      <motion.div
        className="absolute bottom-4 left-1/2 transform -translate-x-1/2 lg:left-0 lg:translate-x-0 lg:bottom-0 bg-white p-4 sm:p-5 rounded-xl shadow-lg w-64 sm:w-72"
    ...
    {/* LEFT TEXT CONTENT */}
    <motion.div
      className="bg-[#0f2d2f] lg:h-full text-white rounded-2xl relative flex flex-col justify-center items-start p-8 lg:p-10 order-2 lg:order-1"
      initial={{ x: -100, opacity: 0 }}
      animate={{ x: 0, opacity: 1 }}
      transition={{ duration: 1 }}
    >
      <span className="text-sm tracking-widest text-teal-300 mb-4">
      ...
      <motion.p
        className="text-gray-300 mt-4 sm:mt-6 max-w-full sm:max-w-md text-start"
        initial={{ y: 20, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
...
<section className="bg-[#faf7f2] min-h-screen flex items-center justify-center py-16">
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="rounded-3xl overflow-hidden border-6 border-white shadow-lg">
              <Image
    ...
    <section className="mx-auto max-w-7xl px-6 py-16"><section className="py-20 bg-[var(--bg-color)]">
      <div className="max-w-7xl mx-auto px-4 flex flex-col lg:flex-row gap-8 items-start">

        {/* Div 1: Headings */}
        <div className="flex-1">
          <h2 className="text-4xl font-extrabold text-[var(--primary-color)] mb-4">
            Proud Projects
          </h2>
